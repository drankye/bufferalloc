...
public class Allocator {
  public enum Type{HEAP,BB,DBB,OFFHEAP, CHECKEDOFFHEAP, INPLACECHECKEDOFFHEAP}
	public static ObjectType allocate(Type type , int items)
	{
        ...
        else if(type.equals(Type.CHECKEDOFFHEAP))
        {
            return new CheckedOffHeapObject(items);
        }
        else if(type.equals(Type.INPLACECHECKEDOFFHEAP))
        {
            return new InPlaceCheckedOffHeapObject(items);
        }
